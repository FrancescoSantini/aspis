...
```bash
MODE=dry-run bash tests/run_g100_deseq2_smoke.sh your_slurm_account
bash tests/run_g100_deseq2_smoke.sh your_slurm_account
```
...
```bash
bash tests/run_g100_smallrna_smoke.sh your_slurm_account
```
...
```bash
MODE=run bash tests/run_g100_smallrna_smoke.sh your_slurm_account
```
