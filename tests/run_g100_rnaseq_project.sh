...
RNASEQ_PREPROCESS_RUNTIME="${ASPIS_RNASEQ_PREPROCESS_RUNTIME:-1440}"
RNASEQ_PREPROCESS_MEM_MB="${ASPIS_RNASEQ_PREPROCESS_MEM_MB:-32000}"
RNASEQ_PREPROCESS_DISK_MB="${ASPIS_RNASEQ_PREPROCESS_DISK_MB:-300000}"
...
"$SNAKEMAKE" "${TARGET_ARGS[@]}" "${FORCE_ARGS[@]}" "$@" \
  ...
  --set-resources \
    ...
    "preprocess_rnaseq_branch:runtime=$RNASEQ_PREPROCESS_RUNTIME" \
    "preprocess_rnaseq_branch:mem_mb=$RNASEQ_PREPROCESS_MEM_MB" \
    "preprocess_rnaseq_branch:disk_mb=$RNASEQ_PREPROCESS_DISK_MB" \
