...
def write_config_fragment(
    ...
    path.write_text(
        ...
        "# This fragment records a local, user-reviewed miRNA-target export.\n"
        "# ASPIS normalizes and audits the table, but it does not grant license\n"
        "# rights for the original target resource.\n\n"
        "resources:\n"
        "  smallrna_targets:\n"
