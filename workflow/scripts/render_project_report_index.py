    ...
    return "\n".join(
        [
            layer_panel(
                ...
                [
                    link(base_dir / "layers/rnaseq_de/index.html", "RNA-seq differential detailed report", base_dir),
                    link(base_dir / "layers/rnaseq_de/technical_report.pdf", "layer technical PDF", base_dir),
            ...
            layer_panel(
                ...
                [
                    link(base_dir / "layers/enrichment/index.html", "GO/Reactome detailed report", base_dir),
                    link(base_dir / "layers/enrichment/technical_report.pdf", "layer technical PDF", base_dir),
            ...
            layer_panel(
                ...
                [
                    link(base_dir / "layers/dtu_splicing/index.html", "DTU/splicing detailed report", base_dir),
                    link(base_dir / "layers/dtu_splicing/technical_report.pdf", "layer technical PDF", base_dir),
            ...
            layer_panel(
                ...
                [
                    link(base_dir / "layers/isoform_switch/index.html", "isoform-switch detailed report", base_dir),
                    link(base_dir / "layers/isoform_switch/technical_report.pdf", "layer technical PDF", base_dir),
            ...
            layer_panel(
                ...
                [
                    link(base_dir / "layers/smallrna_de/index.html", "smallRNA differential detailed report", base_dir),
                    link(base_dir / "layers/smallrna_de/technical_report.pdf", "layer technical PDF", base_dir),
            ...
            layer_panel(
                ...
                [
                    link(base_dir / "layers/mirna_targets/index.html", "miRNA target detailed report", base_dir),
                    link(base_dir / "layers/mirna_targets/technical_report.pdf", "layer technical PDF", base_dir),
            ...
            layer_panel(
                ...
                [
                    link(base_dir / "layers/matched_mirna_mrna/index.html", "matched evidence detailed report", base_dir),
                    link(base_dir / "layers/matched_mirna_mrna/technical_report.pdf", "layer technical PDF", base_dir),
                    table_link(
...
<body>
  ...
  <div class="metrics">
    {metric("configured assays", len(plan_rows))}
